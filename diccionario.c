...
diccionario_t diccionario [256] = {
	...
	[0x61] = {ADC, index_indirecto_x, 6},

	[0x71] = {ADC, index_indirecto_y, 5},	
	...
	[0x21] = {AND, index_indirecto_x, 6},

	[0x31] = {AND, index_indirecto_y, 5},
	...
	[0xC1] = {CMP, index_indirecto_x, 6},

	[0xD1] = {CMP, index_indirecto_y, 5},
	...
	[0x41] = {EOR, index_indirecto_x, 6},

	[0x51] = {EOR, index_indirecto_y, 5},
	...
	[0xA1] = {LDA, index_indirecto_x, 6},

	[0xB1] = {LDA, index_indirecto_y, 5},
	...
	[0x01] = {ORA, index_indirecto_x, 6},

	[0x11] = {ORA, index_indirecto_y, 5},
	...
	[0xE1] = {SBC, index_indirecto_x, 6},

	[0xF1] = {SBC, index_indirecto_y, 5},
	...
	[0x81] = {STA, index_indirecto_x, 6},

	[0x91] = {STA, index_indirecto_y, 6}, //ojo sera 5?
